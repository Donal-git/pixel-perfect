...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"manifest","href":"/manifest.webmanifest"},{"rel":"icon","type":"image/png","href":"/pwa-192x192.png"},{"rel":"apple-touch-icon","href":"/pwa-192x192.png"}],"style":[],"script":[],"noscript":[],"title":"EchoRH"};
